...
export function Home() {
  return (
    <div className="  font-bricolage bg-lightie dark:bg-darkie dark:text-lightie ">
      <AppBar></AppBar>
      <div className="p-20 mt-16">
              ...
              <div className="mx-auto grid max-w-sm items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
                <div className="grid gap-1  border border-darkie dark:border-lightie rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Users can create new survey polls by providing a title,
                ...
                <div className="grid gap-1 border  border-darkie dark:border-lightie rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Users can vote on published survey polls by selecting
                ...
                <div className="grid gap-1 border  border-darkie dark:border-lightie rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    The application prevents users from voting more than once
                    per question and survey.{" "}
                  </p>
                </div>
                <div className="grid gap-1 border  border-darkie dark:border-lightie rounded-lg p-4">
                  <h3 className="text-lg font-bold">Responsive Design</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    The web app is designed with a responsive layout using
                    Tailwind CSS, ensuring a seamless experience across devices.{" "}
                  </p>
                </div>
              </div>
            </div>
        ...
        <footer>
          <div className="flex justify-center">
            <span>
              Made with ❤ by{" "}
              <a href="https://twitter.com/prvn347" className="text-btncolor">
                @prvn
              </a>
            </span>
          </div>
