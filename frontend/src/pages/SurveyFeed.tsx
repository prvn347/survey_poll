...
const [postsPerPage] = useState(10);
 ...
 Loading("/surveys","/signin")
  ...
  return (<RecoilRoot><div className=" font-bricolage">
   <NavBarWrapper>
                <Link to={'/post'} className=" inline font-bricolage p-2  text-md   dark:text-white  hover:text-btncolor  dark:hover:text-btncolor   ">Create Survey</Link>
                ...
                <Link to={''} onClick={hancleOnclick} className=" inline font-bricolage  p-2  dark:text-white  text-md hover:text-btncolor  dark:hover:text-btncolor  ">Logout</Link>
