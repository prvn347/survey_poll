     ...
     return <div>
        <div className=" dark:bg-dark">
            <div><div className="text-center mb-16">
                ...
                <button onClick={handleInput} type="button" className="mt-8 w-full text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-sm text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">{type === "signup" ? "Sign up" : "Sign in"}</button>
                <div>
...
export function LabeledInput({label,type,placeholder,onchange}:post){
    return <div className="flex flex-col">
        ...
        <input onChange={onchange} className="px-2 font-medium py-2 placeholder:text-sm placeholder:font-medium rounded-sm  text-black border shadow-[3px_3px_rgba(0,_98,_90,_0.4),_6px_6px_rgba(0,_98,_90,_0.3)] outline-none border-black w-72 focus:shadow-purple-700" id="input" type={type} placeholder= {placeholder} required />
    </div>
}
