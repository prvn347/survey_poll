    ...
    return (
        <div className="wrapper  dark:bg-darkie   top-0  flex justify-between px-10 py-4 bg-blueish
          ...
          <div className="flex gap-3  justify-center items-center">    
               ...
               <Link className=" text-lg  sm:text-2xl dark:text-white font-bricolage font-semibold " to={'/'}>Survey Poll</Link>
               </div>
               <div className=" flex gap-3">
               {!isSmallScreen && ( // Render the children if not on a small screen
          <div className="flex">
            {children}
          </div>
        )}
