...
const handleLogout = async (  )=> {
    ...
    <div className="bg-white dark:bg-darkie  rounded-lg shadow-lg p-8 max-w-md">
      <div className="flex justify-end">
        <button onClick={toggleModal} className="text-gray-400 hover:text-gray-700">
      ...
      <div className="text-center">
        ...
        <div className="mt-4 flex justify-center">
          <button className="bg-red-600 text-white  px-4 py-2 rounded-lg mr-2 hover:bg-red-700" onClick={handleLogout}>
            {action}
          </button>
          <button className="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-300" onClick={toggleModal}>
            No, cancel
          </button>
        </div>
      </div>
